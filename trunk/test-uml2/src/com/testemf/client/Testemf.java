...
import org.eclipse.uml2.uml.UMLClass;
import org.eclipse.uml2.uml.UMLFactory;
import org.eclipse.uml2.uml.UMLModel;
...
public class Testemf implements EntryPoint {
	...
	private void initUML2(TextArea log) {
		clear(log);
	...
	public void onModuleLoad() {
		...
		}
		{
			VerticalPanel page = new VerticalPanel();
			TextArea src = new TextArea();
			src.setText(Strings.INSTANCE.uml2().getText());
			final TextArea log = new TextArea();
			log.setText("-------------log-----------------------");
			Button btn = new Button("Run Test", new ClickHandler() {

				public void onClick(ClickEvent event) {
					Testemf.this.initUML2(log);
				}
